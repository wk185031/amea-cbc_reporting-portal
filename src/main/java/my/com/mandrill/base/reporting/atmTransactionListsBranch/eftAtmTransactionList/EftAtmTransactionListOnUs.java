...
public class EftAtmTransactionListOnUs extends PdfReportProcessor {
	...
	private void generateBranchReport(ReportGenerationMgr rgm) {
		logger.debug("In EftAtmTransactionListOnUs.generateBranchReport()");
	...
	private void generateMasterListReport(ReportGenerationMgr rgm) {
		logger.debug("In EftAtmTransactionListOnUs.generateMasterListReport()");
		pageHeight = PDRectangle.A4.getHeight() - ReportConstants.PAGE_HEIGHT_THRESHOLD;
		totalHeight = PDRectangle.A4.getHeight();
		PDDocument doc = null;
		pagination = 1;
	...
	private PDPageContentStream executePdfBodyQuery(ReportGenerationMgr rgm, PDDocument doc, PDPage page,
		...
		logger.debug("In EftAtmTransactionListOnUs.executePdfBodyQuery()");
		ResultSet rs = null;
