...
public class AcquirerAtmWithdrawalIncome extends CsvReportProcessor {

	private final Logger logger = LoggerFactory.getLogger(AcquirerAtmWithdrawalIncome.class);
