...
public class ReportGenerationMgr extends ReportGenerationFields {
	...
	public void run(String url, String username, String password) {
		...
		setBodyQuery(CriteriaParamsUtil.replaceInstitution(getBodyQuery(), institution, ReportConstants.VALUE_DEO_NAME, ReportConstants.VALUE_ISSUER_NAME, ReportConstants.VALUE_INTER_ISSUER_NAME, ReportConstants.VALUE_ACQUIRER_NAME, ReportConstants.VALUE_GLA_INST, ReportConstants.VALUE_ACQR_INST_ID));
		setTrailerQuery(CriteriaParamsUtil.replaceInstitution(getTrailerQuery(), institution, ReportConstants.VALUE_DEO_NAME, ReportConstants.VALUE_ISSUER_NAME, ReportConstants.VALUE_INTER_ISSUER_NAME, ReportConstants.VALUE_ACQUIRER_NAME, ReportConstants.VALUE_GLA_INST, ReportConstants.VALUE_ACQR_INST_ID));
