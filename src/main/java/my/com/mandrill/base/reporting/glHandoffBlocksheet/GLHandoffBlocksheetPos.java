...
public class GLHandoffBlocksheetPos extends TxtReportProcessor {
	...
	public void executePdf(ReportGenerationMgr rgm) throws ReportGenerationException {
		logger.debug("In GLHandoffBlocksheetPos.processPdfRecord()");
		PDDocument doc = null;
		PDPage page = null;
	...
	private void preProcessing(ReportGenerationMgr rgm)
		...
		logger.debug("In GLHandoffBlocksheetPos.preProcessing()");
	...
	private void separateQuery(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffBlocksheetPos.separateQuery()");
	...
	private PDPageContentStream executePdfBodyQuery(ReportGenerationMgr rgm, PDDocument doc, PDPage page,
		...
		logger.debug("In GLHandoffBlocksheetPos.executePdfBodyQuery()");
		ResultSet rs = null;
	...
	private boolean executeQuery(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffBlocksheetPos.executeQuery()");
		ResultSet rs = null;
		PreparedStatement ps = null;
		String query = getBodyQuery(rgm);
