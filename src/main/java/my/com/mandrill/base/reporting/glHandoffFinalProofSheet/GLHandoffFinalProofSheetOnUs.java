...
public class GLHandoffFinalProofSheetOnUs extends TxtReportProcessor {
	...
	protected SortedSet<String> filterByBranchCode(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffFinalProofSheetOnUs.filterByBranchCode()");
		String branchCode = null;
		ResultSet rs = null;
	...
	private void separateQuery(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffFinalProofSheetOnUs.separateQuery()");
