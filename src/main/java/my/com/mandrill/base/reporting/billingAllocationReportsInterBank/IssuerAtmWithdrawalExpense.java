...
public class IssuerAtmWithdrawalExpense extends CsvReportProcessor {

	private final Logger logger = LoggerFactory.getLogger(IssuerAtmWithdrawalExpense.class);
