...
public class CashCardLoadingStatistics extends PdfReportProcessor {

	private final Logger logger = LoggerFactory.getLogger(CashCardLoadingStatistics.class);
	...
	public void executePdf(ReportGenerationMgr rgm) throws ReportGenerationException {
		logger.debug("In CashCardLoadingStatistics.processPdfRecord()");
		PDDocument doc = null;
		pagination = 1;
		try {
			doc = new PDDocument();
	...
	private PDPageContentStream executePdfBodyQuery(ReportGenerationMgr rgm, PDDocument doc, PDPage page,
		...
		logger.debug("In CashCardLoadingStatistics.executePdfBodyQuery()");
		ResultSet rs = null;
