...
public class GLHandoffFinalProofSheetIssuer extends TxtReportProcessor {
	...
	protected List<String> filterByGlDescription(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffFinalProofSheetIssuer.filterByGlDescription()");
		String glDescription = null;
		ResultSet rs = null;
		...
		logger.info("Query for filter gl description: {}", query);
	...
	private void separateQuery(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffFinalProofSheetIssuer.separateQuery()");
