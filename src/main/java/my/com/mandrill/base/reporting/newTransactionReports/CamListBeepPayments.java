...
public class CamListBeepPayments extends CsvReportProcessor {

	private final Logger logger = LoggerFactory.getLogger(CamListBeepPayments.class);
	...
	protected void execute(ReportGenerationMgr rgm, File file) {
		...
		try {
			...
			line.append(ReportConstants.CHANNEL + " : ").append(";").append(ReportConstants.CAM).append(";");
			line.append(getEol());
	...
	private void preProcessing(ReportGenerationMgr rgm)
		...
		logger.debug("In CamListBeepPayments.preProcessing()");
