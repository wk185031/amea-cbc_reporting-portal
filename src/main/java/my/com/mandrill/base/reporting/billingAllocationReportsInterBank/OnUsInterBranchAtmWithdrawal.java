...
public class OnUsInterBranchAtmWithdrawal extends CsvReportProcessor {

	private final Logger logger = LoggerFactory.getLogger(OnUsInterBranchAtmWithdrawal.class);
