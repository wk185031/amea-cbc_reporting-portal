...
public class InterBankFundTransferReportAtmRejectedTransaction extends CsvReportProcessor {
	...
	private SortedMap<String, String> filterByBranch(ReportGenerationMgr rgm) {
		logger.debug("In InterBankFundTransferReportAtmRejectedTransaction.filterByBranch()");
		String branchCode = null;
		String branchName = null;
		ResultSet rs = null;
	...
	private SortedMap<String, Map<String, Map<String, Map<String, String>>>> filterByIssuingReceiving(
		...
		logger.debug("In InterBankFundTransferReportAtmRejectedTransaction.filterByIssuingReceiving()");
		String branchCode = null;
		String branchName = null;
		String bankCode = null;
		String bankName = null;
