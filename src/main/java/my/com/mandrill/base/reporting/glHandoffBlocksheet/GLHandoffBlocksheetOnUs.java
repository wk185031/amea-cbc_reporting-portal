...
public class GLHandoffBlocksheetOnUs extends TxtReportProcessor {
	...
	private void pdfProcessingDetail(ReportGenerationMgr rgm, String branchCode, PDPageContentStream contentStream,
		...
		logger.debug("In GLHandoffBlocksheetOnUs.pdfProcessingDetail()");
		try {
			preProcessing(rgm, branchCode);
	...
	private void processingDetail(ReportGenerationMgr rgm, String branchCode) {
		logger.debug("In GLHandoffBlocksheetOnUs.processingDetail()");
		try {
			preProcessing(rgm, branchCode);
	...
	protected SortedSet<String> filterByBranchCode(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffBlocksheetOnUs.filterByBranchCode()");
		String branchCode = null;
		ResultSet rs = null;
	...
	private void separateQuery(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffBlocksheetOnUs.separateQuery()");
