...
public class EftAtmTransactionListOtherBanks extends PdfReportProcessor {
	...
	private void generateBranchReport(ReportGenerationMgr rgm) throws ReportGenerationException {
		logger.debug("In EftAtmTransactionListOtherBanks.generateBranchReport()");		
	...
	private void generateMasterListReport(ReportGenerationMgr rgm) throws ReportGenerationException {
		logger.debug("In EftAtmTransactionListOtherBanks.generateMasterListReport()");
		pageHeight = PDRectangle.A4.getHeight() - ReportConstants.PAGE_HEIGHT_THRESHOLD;
		totalHeight = PDRectangle.A4.getHeight();
		PDDocument doc = null;
		pagination = 1;
...
//							getBranchQueryStatement(rgm.getInstitution(), "ABR.ABR_CODE"))
	...
	private PDPageContentStream executePdfBodyQuery(ReportGenerationMgr rgm, PDDocument doc, PDPage page,
		...
		logger.debug("In EftAtmTransactionListOtherBanks.executePdfBodyQuery()");
		ResultSet rs = null;
