...
public class GLHandoffBlocksheetIssuer extends TxtReportProcessor {
	...
	private void pdfProcessingDetail(ReportGenerationMgr rgm, PDPageContentStream contentStream, PDDocument doc,
			...
			float fontSize) {
		logger.debug("In GLHandoffBlocksheetIssuer.pdfProcessingDetail()");
		try {
	...
	private void processingDetail(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffBlocksheetIssuer.processingDetail()");
		try {
	...
	private void separateQuery(ReportGenerationMgr rgm) {
		logger.debug("In GLHandoffBlocksheetIssuer.separateQuery()");
