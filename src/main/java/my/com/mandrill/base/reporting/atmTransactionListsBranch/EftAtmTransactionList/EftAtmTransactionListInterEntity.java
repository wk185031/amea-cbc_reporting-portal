...
public class EftAtmTransactionListInterEntity extends PdfReportProcessor {
	...
	private void generateBranchReport(ReportGenerationMgr rgm) {
		logger.debug("In EftAtmTransactionListInterEntity.generateBranchReport()");
	...
	private void generateMasterListReport(ReportGenerationMgr rgm) {
		logger.debug("In EftAtmTransactionListInterEntity.generateMasterListReport()");
		pageHeight = PDRectangle.A4.getHeight() - ReportConstants.PAGE_HEIGHT_THRESHOLD;
		totalHeight = PDRectangle.A4.getHeight();
		PDDocument doc = null;
		boolean isRecordsExist = false;
	...
	private PDPageContentStream executePdfBodyQuery(ReportGenerationMgr rgm, PDDocument doc, PDPage page,
		...
		logger.debug("In EftAtmTransactionListInterEntity.executePdfBodyQuery()");
		ResultSet rs = null;
