...
public class SummaryNetSettlementApprovedInstaPayTransactions extends CsvReportProcessor {
	...
	private final Logger logger = LoggerFactory.getLogger(SummaryNetSettlementApprovedInstaPayTransactions.class);
	...
	private void separateQuery(ReportGenerationMgr rgm) {
		logger.debug("In SummaryNetSettlementApprovedInstaPayTransactions.separateQuery()");
	...
	private void preProcessing(ReportGenerationMgr rgm, String indicator) {
		logger.debug("In SummaryNetSettlementApprovedInstaPayTransactions.preProcessing()");
	...
	protected void writeBodyHeader(ReportGenerationMgr rgm) throws IOException, JSONException {
		logger.debug("In SummaryNetSettlementApprovedInstaPayTransactions.writeBodyHeader()");
	...
	private void writeTrailer(ReportGenerationMgr rgm)
		...
		logger.debug("In SummaryNetSettlementApprovedInstaPayTransactions.writeTrailer()");
