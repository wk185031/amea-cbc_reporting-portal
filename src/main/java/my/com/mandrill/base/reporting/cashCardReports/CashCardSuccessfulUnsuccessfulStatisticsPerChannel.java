...
public class CashCardSuccessfulUnsuccessfulStatisticsPerChannel extends PdfReportProcessor {
	private final Logger logger = LoggerFactory.getLogger(CashCardSuccessfulUnsuccessfulStatisticsPerChannel.class);
	...
	private PDPageContentStream executePdfBodyQuery(ReportGenerationMgr rgm, PDDocument doc, PDPage page,
		...
		logger.debug("In CashCardSuccessfulUnsuccessfulStatisticsPerChannel.executePdfBodyQuery()");
		ResultSet rs = null;
	...
	protected SortedMap<String, Set<String>> filterByChannel(ReportGenerationMgr rgm) {
		logger.debug("In CashCardSuccessfulUnsuccessfulStatisticsPerChannel.filterByChannel()");
		String channel = null;
		String txnType = null;
		ResultSet rs = null;
		PreparedStatement ps = null;
