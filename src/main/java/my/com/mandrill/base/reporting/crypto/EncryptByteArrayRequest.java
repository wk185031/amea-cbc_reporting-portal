 ...
 *         &lt;element name="Body" type="{http://jms.crypto.authentic.com/CryptoService/types}encryptRequestBody"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "EncryptByteArrayRequest")
public class EncryptByteArrayRequest {

	@XmlElement(name = "Header", required = true)
	protected CryptoHeaderType header;
	@XmlElement(name = "Body", required = true)
	protected EncryptRequestBody body;
	 ...
	 * 
	 * @return possible object is {@link EncryptRequestBody }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link EncryptRequestBody }
	 * 
	 */
	public void setBody(EncryptRequestBody value) {
		this.body = value;
	}
}
