...
public class EftAtmTransactionListOtherBanks extends GeneralReportProcess {

	private final Logger logger = LoggerFactory.getLogger(EftAtmTransactionListOtherBanks.class);
	...
	public void processPdfRecord(ReportGenerationMgr rgm) {
		logger.debug("In EftAtmTransactionListOtherBanks.processPdfRecord()");
		PDDocument doc = null;
		pagination = 1;
		try {
			doc = new PDDocument();
	...
	private PDPageContentStream execute(ReportGenerationMgr rgm, PDDocument doc, PDPage page,
		...
		logger.debug("In EftAtmTransactionListOtherBanks.execute()");
		ResultSet rs = null;
	...
	private SortedMap<String, Map<String, Set<String>>> filterByCriteria(ReportGenerationMgr rgm) {
		logger.debug("In EftAtmTransactionListOtherBanks.filterByCriteria()");
		String branchCode = null;
		String branchName = null;
		String terminal = null;
		ResultSet rs = null;
	...
	private void preProcessing(ReportGenerationMgr rgm)
		...
		logger.debug("In EftAtmTransactionListOtherBanks.preProcessing()");
	...
	private void addPreProcessingFieldsToGlobalMap(ReportGenerationMgr rgm) {
		logger.debug("In EftAtmTransactionListOtherBanks.addPreProcessingFieldsToGlobalMap()");
	...
	private void writePdfHeader(ReportGenerationMgr rgm, PDPageContentStream contentStream, float leading,
		...
		logger.debug("In EftAtmTransactionListOtherBanks.writePdfHeader()");
		addPreProcessingFieldsToGlobalMap(rgm);
	...
	private void writePdfBodyHeader(ReportGenerationMgr rgm, PDPageContentStream contentStream, float leading)
		...
		logger.debug("In EftAtmTransactionListOtherBanks.writePdfBodyHeader()");
