...
import my.com.mandrill.base.domain.AbstractAuditingEventEntity;
import my.com.mandrill.base.domain.EntityAuditEvent;
import my.com.mandrill.base.repository.EntityAuditEventRepository;
...
public class AsyncEntityAuditEventWriter {
    ...
    private EntityAuditEvent prepareAuditEntity(final Object entity, EntityAuditAction action) {
        ...
        final AbstractAuditingEventEntity abstractAuditEntity = (AbstractAuditingEventEntity) entity;
