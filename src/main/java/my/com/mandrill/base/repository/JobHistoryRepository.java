...
public interface JobHistoryRepository extends JpaRepository<JobHistory, Long> {
    ...
    public Page<JobHistory> findLatestReportGenerated(Pageable pageable, @Param("loginId") String loginId, @Param("jobName") String jobName, @Param("insId") String insId);
	...
	@Query("select jobHistory from JobHistory jobHistory join jobHistory.job job where jobHistory.createdBy IN ('system', :loginId) and job.name = :jobName and "
			...
			+ "and JSON_VALUE(jobHistory.details, '$.institutionId') = :insId")
    public Page<JobHistory> findReportGeneratedByDate(Pageable pageable, @Param("loginId") String loginId, @Param("jobName") String jobName, @Param("startDate") String startDate, 
    		@Param("endDate") String endDate, @Param("insId") String insId);
