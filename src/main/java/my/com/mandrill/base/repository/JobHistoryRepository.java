...
public interface JobHistoryRepository extends JpaRepository<JobHistory, Long> {
    ...
    public Page<JobHistory> findReportGenereatedByDate(Pageable pageable, @Param("loginId") String loginId, @Param("jobName") String jobName, @Param("startDate") String startDate, @Param("endDate") String endDate);
}
