...
DECLARE
	...
	i_BODY_FIELDS CLOB;
	i_BODY_QUERY CLOB;
	i_PROCESSING_CLASS VARCHAR2(100) := 'my.com.mandrill.base.reporting.ListOfGroupRole';
...
BEGIN 
	  ...
	  i_BODY_QUERY := TO_CLOB('select re1.NAME as Role_ID,
        ...
        (select RTRIM(XMLAGG(XMLELEMENT(E,ju3.LOGIN,'','').EXTRACT(''//text()'') ORDER BY ju3.LOGIN).GetClobVal(),'','') AS LIST
		    from JHI_USER ju3
