...
DECLARE
	i_REPORT_NAME VARCHAR2(100) := 'Final Proof Sheet For POS';
...
FROM(
SELECT
	  DISTINCT GLE.GLE_DEBIT_DESCRIPTION "Tran Particular",
...
FROM(
SELECT
      DISTINCT GLE.GLE_CREDIT_DESCRIPTION "Tran Particular",
      GLA.GLA_NUMBER "GL ACCOUNT NUMBER",
      GLA.GLA_NAME "GL ACCOUNT NAME",
      0 AS "DEBITS",
