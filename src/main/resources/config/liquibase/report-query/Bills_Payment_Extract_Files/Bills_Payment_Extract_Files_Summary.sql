...
BEGIN
  ...
  i_BODY_QUERY := TO_CLOB('
    ...
    FROM
      ...
      LEFT JOIN CBC_BILLER CBL ON LPAD(TXNC.TRL_BILLER_CODE, 3, ''0'') = LPAD(CBL.CBL_CODE, 3, ''0'')
    WHERE
      TXN.TRL_TSC_CODE = 50
