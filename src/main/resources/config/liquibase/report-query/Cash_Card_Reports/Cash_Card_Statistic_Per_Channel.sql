...
FROM
  ...
  LEFT JOIN CBC_TRAN_CODE CTR ON 
      ...
      AND CTR.CTR_CHANNEL = CASE WHEN (TXN.TRL_DEO_NAME = {V_IE_Deo_Name} OR LPAD(TXN.TRL_FRD_REV_INST_ID, 10) = {V_IE_Acqr_Inst_Id}) THEN CONCAT(''I-'', TXNC.TRL_ORIGIN_CHANNEL) ELSE TXNC.TRL_ORIGIN_CHANNEL END
...
WHERE
  ...
  AND TXN.TRL_SYSTEM_TIMESTAMP >= TO_DATE(''20210628 00:00:00'', ''YYYYMMDD HH24:MI:SS'') AND TXN.TRL_SYSTEM_TIMESTAMP < TO_DATE(''20210629 00:00:00'',''YYYYMMDD HH24:MI:SS'')
GROUP BY
