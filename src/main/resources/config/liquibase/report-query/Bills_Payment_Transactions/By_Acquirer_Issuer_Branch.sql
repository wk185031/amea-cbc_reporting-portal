...
UPDATE REPORT_DEFINITION SET RED_HEADER_FIELDS = i_HEADER_FIELD, RED_FILE_FORMAT='CSV,', RED_BODY_FIELDS=i_BODY_FIELD, RED_BODY_QUERY=i_BODY_QUERY, RED_TRAILER_FIELDS=null, RED_TRAILER_QUERY=null WHERE RED_NAME = 'Daily Payment Transaction Report by Acquirer/Issuer Branch';
