...
-- CBCAXUPISSLOG-869	13-AUG-2021		NY		Amount not tally in GL and txn summary for onus	  
...
END		
	...
	WHERE RED_NAME = 'Block Sheet Listing For On-Us' AND RED_INS_ID = 22;
	...
	UPDATE REPORT_DEFINITION SET 
		...
		RED_BODY_QUERY = i_BODY_QUERY,
		RED_TRAILER_QUERY = i_TRAILER_QUERY
	WHERE RED_NAME = 'Block Sheet Listing For On-Us' AND RED_INS_ID = 2;
