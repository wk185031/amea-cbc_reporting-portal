...
WHERE
	  ...
	  AND (TXN.TRL_TSC_CODE NOT IN (1, 2, 21, 22, 26, 31, 41, 51, 52, 122, 145, 146, 246) OR (TXN.TRL_TSC_CODE = 1 AND TXN.TRL_FRD_REV_INST_ID IS NULL AND TXNC.TRL_ORIGIN_CHANNEL NOT IN (''EBK'', ''MBK'')))
