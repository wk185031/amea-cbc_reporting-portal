...
-- JIRA-936				23-SEP-2021		WY		Fix total count and amount to exclude reversed txn
...
FROM
      ...
      LEFT JOIN CBC_TRAN_CODE CTR ON TXN.TRL_TSC_CODE = CTR.CTR_CODE AND (CASE WHEN TXNC.TRL_ORIGIN_CHANNEL = ''BRM'' THEN ''I-CDM'' ELSE ''I-'' || TXNC.TRL_ORIGIN_CHANNEL END) = CTR.CTR_CHANNEL 
