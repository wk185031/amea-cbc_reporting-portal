...
-- Acquirer				25-AUG-2021		NY		Internal finding, approved but reversed not adding bad trans count
...
-- CBS header/body/trailer fields	
	...
	WHERE RED_NAME = 'Transaction Summary Grand Total for Other Banks' AND RED_INS_ID = 22;
	...
	UPDATE REPORT_DEFINITION SET 
		...
		RED_BODY_QUERY = i_BODY_QUERY,
		RED_TRAILER_QUERY = i_TRAILER_QUERY
	WHERE RED_NAME = 'Transaction Summary Grand Total for Other Banks' AND RED_INS_ID = 2;
