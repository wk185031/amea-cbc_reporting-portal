...
-- CBS header/body/trailer fields	
	...
	WHERE RED_NAME = 'Transaction Summary Grand Total for On-Us and Other Branches Accounts' AND RED_INS_ID = 22;
	...
	UPDATE REPORT_DEFINITION SET 
		...
		RED_BODY_QUERY = i_BODY_QUERY,
		RED_TRAILER_QUERY = i_TRAILER_QUERY
	WHERE RED_NAME = 'Transaction Summary Grand Total for On-Us and Other Branches Accounts' AND RED_INS_ID = 2;
