...
DECLARE
    ...
    i_PROCESSING_CLASS VARCHAR2(200) := 'my.com.mandrill.base.reporting.atmTransactionListsBranch.transactionSummaryGrandTotal.TransactionSummaryGrandTotalCashCard';
...
FROM (
  ...
  CASE WHEN TXN.TRL_TQU_ID = ''R'' THEN TXN.TRL_AMT_TXN*-1 WHEN TXN.TRL_ACTION_RESPONSE_CODE = 0 THEN TXN.TRL_AMT_TXN ELSE 0 END AS "CASH DISPENSED"	
FROM
      TRANSACTION_LOG TXN
