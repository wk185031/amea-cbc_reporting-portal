...
-- CBS header/body/trailer fields
	...
	i_BODY_QUERY_2 := TO_CLOB('Union All
		...
		SELECT DISTINCT
			...
			CASE WHEN STS_ID = 69 THEN IDCR.DCR_NUMBER ELSE JSON_VALUE(IDCR.DCR_CIF_RESPONSE, ''$.bankAccountCollection.bacAccountNumber'') END AS ACC_NO,
			INS.INS_CODE AS INSTITUTION_ID,
			IC.CRD_KEY_ROTATION_NUMBER ROTATION_NUMBER,
			STF1.STF_LOGIN_NAME As Maker,
			STF2.STF_LOGIN_NAME As Checker,
		...
		SELECT DISTINCT
			...
			CASE WHEN STS_ID = 69 THEN ICCR.CCR_NUMBER ELSE JSON_VALUE(ICCR.CCR_CIF_RESPONSE, ''$.bankAccountCollection.bacAccountNumber'') END AS ACC_NO,
			INS.INS_CODE AS INSTITUTION_ID,
			ICC.CSH_KEY_ROTATION_NUMBER ROTATION_NUMBER,
			STF1.STF_LOGIN_NAME As Maker,
			STF2.STF_LOGIN_NAME As Checker,
