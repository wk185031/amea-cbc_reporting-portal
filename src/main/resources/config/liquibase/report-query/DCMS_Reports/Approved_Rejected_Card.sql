...
-- CBS header/body/trailer fields
	...
	i_BODY_QUERY_2 := TO_CLOB('Union All
		...
		SELECT DISTINCT
			...
			CASE WHEN IDCR.DCR_STS_ID IN (68,69) THEN IDCR.DCR_NUMBER ELSE {DCMS_Schema}.get_accno@{DB_LINK_DCMS}(IDCR.DCR_ID)
	...
	UNION ALL
		SELECT
			...
			FROM
        		...
        		--JOIN {DCMS_Schema}.MASTER_STATUS@{DB_LINK_DCMS} MS_FROM ON CCA.CAC_STS_ID=MS_FROM.STS_ID
