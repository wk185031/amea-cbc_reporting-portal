...
SELECT DISTINCT
      ...
      CASE WHEN TXN.TRL_ACTION_RESPONSE_CODE = 0 AND TXN.TRL_TSC_CODE IN (1, 128, 142, 143) AND TXNC.TRL_ORIGIN_CHANNEL NOT IN (''EBK'', ''MBK'') THEN TXN.TRL_AMT_TXN ELSE 0 END AS "CASH DISPENSED",
      CASE 
