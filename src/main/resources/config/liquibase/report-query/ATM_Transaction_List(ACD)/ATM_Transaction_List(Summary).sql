...
SELECT
    ...
    SELECT DISTINCT
      CASE 
		WHEN TXN.TRL_TSC_CODE = 1 AND TXN.TRL_TQU_ID = ''R'' AND LPAD(TXN.TRL_FRD_REV_INST_ID, 10, ''0'') = ''0000008882'' THEN ''BRP''
        WHEN TXN.TRL_TSC_CODE = 1 AND TXN.TRL_TQU_ID = ''F'' AND LPAD(TXN.TRL_FRD_REV_INST_ID, 10, ''0'') = ''0000008882'' THEN ''BPR''
		WHEN TXN.TRL_TSC_CODE = 1 AND TXN.TRL_TQU_ID = ''R'' AND LPAD(TXN.TRL_FRD_REV_INST_ID, 10, ''0'') != ''0000008882'' THEN ''BTR''
        WHEN TXN.TRL_TSC_CODE = 1 AND TXN.TRL_TQU_ID = ''F'' AND LPAD(TXN.TRL_FRD_REV_INST_ID, 10, ''0'') != ''0000008882'' THEN ''BTD''
