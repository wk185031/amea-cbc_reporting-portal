...
SELECT
	...
	SELECT DISTINCT
      ...
      CASE WHEN TXN.TRL_ACTION_RESPONSE_CODE = 0 AND TXN.TRL_TSC_CODE IN (50, 51, 133, 146, 246) THEN TXN.TRL_AMT_TXN ELSE 0 END AS "BILL/INS PAYMENTS",
...
SELECT
	...
	SELECT DISTINCT
	  ...
	  CASE WHEN TXN.TRL_POST_COMPLETION_CODE = ''R'' AND TXN.TRL_TSC_CODE IN (50, 51, 133, 146, 246) THEN TXN.TRL_AMT_TXN ELSE 0 END AS "BP REV",
