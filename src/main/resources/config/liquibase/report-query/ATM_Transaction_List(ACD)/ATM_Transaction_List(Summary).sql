...
SELECT
	...
	SELECT DISTINCT
      CASE 
		WHEN TXN.TRL_TQU_ID = ''R'' AND TXN.TRL_FRD_REV_INST_ID IS NOT NULL AND TXN.TRL_TSC_CODE = 1 THEN ''BTR''
	    WHEN TXN.TRL_TQU_ID = ''F'' AND TXN.TRL_FRD_REV_INST_ID IS NOT NULL AND TXN.TRL_TSC_CODE = 1 THEN ''BTD''
		WHEN TXN.TRL_TQU_ID = ''R'' THEN CTR.CTR_REV_MNEM 
