...
SELECT
      ...
      CONCAT(SUBSTR(LPAD(TRL_ACQR_INST_ID, 10, ''0''), 7),  TXN.TRL_CARD_ACPT_TERMINAL_IDENT) "ATM CODE",
      CBA_ACQ.CBA_MNEM "BANK MNEM",
      TXN.TRL_STAN "SEQ NUMBER",
      SUBSTR(TXN.TRL_RRN, 9, 4) "TRACE NUMBER",
      TXN.TRL_PAN "ATM CARD NUMBER",
      TXN.TRL_PAN_EKY_ID,
      SUBSTR(LPAD(TRL_ACQR_INST_ID, 10, ''0''), 7) "BANK CODE ACQ",
