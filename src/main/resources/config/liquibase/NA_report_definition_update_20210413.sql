...
-- GL Handoff FilesGL Handoff Files
    -- ATM CBC GL BP 001
...
UPDATE REPORT_DEFINITION set RED_TRAILER_FIELDS = i_TRAILER_FIELD, RED_BODY_QUERY = i_BODY_QUERY, RED_TRAILER_QUERY = i_TRAILER_QUERY WHERE RED_NAME = 'ATM CBC GL BP 001';
...
UPDATE REPORT_DEFINITION set RED_BODY_QUERY = i_BODY_QUERY, RED_TRAILER_QUERY = i_TRAILER_QUERY WHERE RED_NAME = 'Final Proof Sheet For Bills Payment';
