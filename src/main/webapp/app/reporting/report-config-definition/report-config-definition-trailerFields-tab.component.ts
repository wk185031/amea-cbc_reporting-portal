...
@Component({
    selector: 'report-config-definition-trailerFields-tab',
    templateUrl: './report-config-definition-trailerFields-tab.component.html'
})
export class ReportConfigDefinitionTrailerFieldsTabComponent implements OnChanges {
    ...
    fieldFormatOptions: string[] = ['', ',', '0.00', '#,##0.00', 'yyMMdd', 'MMddyyyy', 'MM/dd/yyyy', 'MM/dd/yy', 'dd/MM/yyyy', 'ddMMyyyy', 'yyyyMMdd', 'dd/MM/yyyy HH:mm', 'HH:mm', 'HH:mm:ss', 'HH:mm:ss a', 'hhmmss', 'HHmmss'];
