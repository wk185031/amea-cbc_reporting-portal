...
currentAccount: any;
        ...
        if (this.currentSearch) {
            this.systemConfigurationService.search({
                ...
                sort: this.sort()}).subscribe(
                    (res: HttpResponse<SystemConfiguration[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/app-admin-system-configuration'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/app-admin-system-configuration', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
