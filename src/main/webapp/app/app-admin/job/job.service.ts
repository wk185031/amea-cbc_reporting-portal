...
export class JobService {
    ...
    private convertItemFromServer(job: Job): Job {
        ...
        copy.createdDate = this.dateUtils
            .convertDateTimeFromServer(job.createdDate);
        copy.scheduleTime = this.dateUtils
            .convertDateTimeFromServer(job.scheduleTime);
        return copy;
    }
    ...
    private convert(job: Job): Job {
        const copy: Job = Object.assign({}, job);
        copy.createdDate = this.dateUtils.toDate(job.createdDate);
        copy.scheduleTime = this.dateUtils.toDate(job.scheduleTime);
        return copy;
    }
}
